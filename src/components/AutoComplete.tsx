    ...
    <Popover placement="bottom" componentRef={popoverComponentRef} closeDelay={100}>
          ...
          suffix={(innerhandler) =>
            innerhandler.text ? (
              <Icon
                ...
                className={`text-[rgba(196,214,255,0.5)] transition clickable ${innerhandler.text ? 'opacity-100' : 'opacity-0 pointer-events-none'
                  }`}
                onClick={() => {
      ...
      <Popover.Panel style={{ width: inputWidth }}>
        {renderCandidatePanelCard ? (
          ...
          <Card
            className="flex flex-col py-3 border-1.5 border-[#abc4ff80] bg-[#04133d] shadow-cyberpunk-card"
            size="md"
          >
            <div
