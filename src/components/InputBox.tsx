...
export default function InputBox({
  ...
  return (
    <Col
      onClick={focusInput}
      className={twMerge(
        `bg-[#04133d] justify-between rounded-xl mobile:rounded-lg py-3 px-6 mobile:py-2 mobile:px-4 cursor-text ${disabled && !noDisableStyle ? 'pointer-events-none-entirely cursor-default opacity-50' : ''
        }`,
        className
      )}
    >
