...
export function NormalNotificationItemCard({ info, close }: { info: NormalNotificationItemInfo; close: () => void }) {
  ...
  return (
    <Card
      domRef={itemRef}
      className={`min-w-[260px] relative rounded-xl ring-1.5 ring-inset ${colors[type].ring} bg-[#194755] py-4 pl-5 pr-10 mx-4 my-2 overflow-hidden pointer-events-auto`}
    >
      {/* timeline */}
