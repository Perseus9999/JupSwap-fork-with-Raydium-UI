...
function RPCPerformanceBanner({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <FadeIn>
        {isLowRpcPerformance && (
          <div className="bg-[#dacc363f] text-center text-[#e3dc8b] text-sm mobile:text-xs px-4 py-1">
...
function NoneATABanner({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <FadeIn>
        {hasMigratableTokens && (
          <div className="flex justify-center bg-[#dacc363f] text-center text-[#e3dc8b] text-sm mobile:text-xs px-4 py-1">
            <div>
      ...
      {({ close }) => (
        ...
        >
          <Col className="items-center">
            <div className="font-semibold text-xl text-[#e3dc8b] mb-3 text-center">New version available</div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* content */}
        <div className="grow text-sm leading-normal text-[#abc4ffb3] scrollbar-width-thin overflow-auto h-96 mobile:h-12 rounded p-4 my-6 mobile:my-4 bg-[#04133d]">
          <p className="mb-3">
  ...
  return (
    <>
      <Row
        ...
        className="self-stretch gap-4 items-center justify-between font-medium px-3 bg-[#04133d] rounded-lg"
      >
        {/* title */}
  ...
  return (
    ...
    >
      <Row className="items-center">
        ...
        <Row
          className={`grow items-center justify-between text-[#ACE3E5] ${isCurrentRoutePath ? 'text-[#03ccc6]' : ''
            } text-md mobile:text-[0.85rem] font-medium`}
        >
          <div>{children}</div>
          {isExternalLink && (
  ...
  return (
    ...
    >
      <Row className="items-center w-full mobile:justify-center" onClick={onClick}>
        <Icon
          className="mr-3 text-[#03ccc6]"
          size={isMobile ? 'xs' : 'sm'}
          iconSrc={iconSrc}
          heroIconName={heroIconName}
        />
        <span
          className={`text-[#ACE3E5] text-sm mobile:text-[0.85rem] font-medium flex-grow ${href ? 'group-hover:text-[#03ccc6]' : ''
            }`}
        >
          {children}
        </span>
