...
function PercentTag({
  ...
  return (
    <div
      className={twMerge(
        'text-[#ABC4FF] font-medium text-sm mobile:text-xs m-0.25 bg-[#04133d80] rounded-lg mobile:rounded-md hover:bg-[#ABC4FF] hover:text-[#1B1659] py-1 px-3 mobile:px-2 clickable',
        className
      )}
      onClick={() => {
