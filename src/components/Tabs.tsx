    ...
    <RadioGroup
      ...
      itemClassName={(checked) =>
        twMerge(
          ...
          `grid rounded-full place-items-center font-medium whitespace-nowrap ${checked ? 'text-white' : 'text-[#ABC4FF]'
          }`,
      ...
      itemStyle={(checked) =>
        checked
          ? {
            background: 'linear-gradient(245.22deg, rgb(46 139 239), rgb(43, 106, 255), rgb(57, 208, 216)) 100% center / 200% 100%',
