      ...
      {({ close: closeDialog }) => (
        ...
        >
          ...
          <div className="text-[#abc4ff]">
            ...
            <p className="text-[#f04a44] mt-3">Calculations are an estimate and only for reference.</p>
          </div>
          ...
          <Col className="gap-2 my-4">
            ...
            {choices.map((choice) => {
              ...
              return (
                <Grid
                  className={`grid-cols-2-auto gap-y-3 py-3 px-5 rounded-xl bg-[#04133d] ${isCurrent ? 'border-1.5 border-[#39d0d8]' : 'border-1.5 border-transparent'
                    } transition-colors`}
                  key={choice.title}
