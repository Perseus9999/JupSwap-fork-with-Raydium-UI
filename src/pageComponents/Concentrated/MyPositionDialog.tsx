...
function MyPositionCardTopInfo({ className }: { className?: string }) {
  ...
  return (
    <Row className={twMerge('flex-wrap bg-[#04133d] grid-cols-4 py-3 px-4 rounded-xl gap-12 mobile:gap-4', className)}>
...
function MyPositionCardChartInfo({ className }: { className?: string }) {
  ...
  return (
    <Col className={twMerge('bg-[#04133d] py-3 px-4 rounded-xl gap-4', className)}>
      <Row className="items-center gap-2">
...
function MyPositionCardPoolOverview({ className }: { className?: string }) {
  ...
  return (
    <Collapse openDirection="upwards" className="w-full mt-4">
      <Collapse.Body>
        <div className="pb-4">
          <div className={twMerge('bg-[#04133d] py-3 px-4 rounded-xl gap-4 ', className)}>
...
function RangeTag({ positionAccount }: { positionAccount?: UserPositionAccount }) {
  ...
  return positionAccount.inRange ? (
    ...
    <Row className="items-center bg-[#f04a44]/10 rounded text-xs text-[#f04a44] py-0.5 px-1 ml-2">
