  ...
  return (
    <FadeIn>
      {solBalance && lt(solBalance, solLeastBalance ?? SOL_BASE_BALANCE) && gte(solBalance, 0) && (
        <Row className={twMerge('text-sm mt-2 text-[#e3dc8b] items-center justify-center', className)}>
          ...
          <Tooltip placement="bottom-right">
            ...
            <Tooltip.Panel>
              <p className="w-80">
                {tooltipText ??
                  `SOL is needed for Solana network fees. A minimum balance of ${solLeastBalance ?? SOL_BASE_BALANCE
                  } SOL is
