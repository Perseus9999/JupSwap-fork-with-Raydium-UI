...
function InputLocked() {
  return (
    <div className="absolute text-sm flex flex-col border-1.5 border-[#abc4ff40] text-center justify-center items-center p-2 w-full h-full bg-[#04133d] bg-opacity-80 z-10 rounded-xl">
