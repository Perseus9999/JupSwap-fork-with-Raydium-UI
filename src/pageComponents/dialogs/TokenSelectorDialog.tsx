        ...
        <>
          <div className="px-8 mobile:px-6 pt-6 pb-5">
            ...
            <Input
              ...
              className="py-3 px-4 rounded-xl bg-[#04133d]"
        ...
        <Row>
            ...
            <Row>
              ...
              {isUserAddedToken ? (
                <Row
                  ...
                  className="group-hover:flex hidden items-center text-sm mobile:text-xs text-[#03ccc6] font-medium flex-nowrap px-2 gap-1"
                >
          ...
          {/* {canFlaggedTokenMints.has(token.mintString) ? (
            <div
              ...
              className="group-hover:visible invisible inline-block text-sm mobile:text-xs text-[#03ccc6]  p-2 "
            >
          ...
          {isCustomTokenSymbolName ? (
            <div
              ...
              className="group-hover:visible invisible mobile:group-hover:block mobile:hidden inline-block text-sm mobile:text-xs text-[#03ccc6]  p-2 "
            >
              [Edit Token]
            </div>
          ) : null} new 🚑 no need */}
