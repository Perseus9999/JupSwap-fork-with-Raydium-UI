...
function PanelContent({
  ...
  return (
    ...
    >
      ...
      {/* Disclaimer */}
      <div className="grow text-sm mobile:text-xs leading-normal text-[#abc4ffb3] rounded p-4 mobile:p-2 mobile:px-4 mb-6 mobile:mb-4 mx-8 mobile:mx-6 bg-[#04133d]">
        By connecting your wallet, you acknowledge that you have read, understand and accept the terms in the
        <Link href="#" className="text-[#abc4ff] px-1.5" onClick={close}>
          Disclaimer
        </Link>
      </div>
