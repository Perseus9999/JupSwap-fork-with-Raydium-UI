  ...
  return (
    <>
      ...
      <Row className="gap-3 justify-between">
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.EXPLORER ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.SOLSCAN ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.SOLANAFM ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
