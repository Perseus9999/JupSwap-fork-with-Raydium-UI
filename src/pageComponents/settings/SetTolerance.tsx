  ...
  return (
    <>
      ...
      <Row className="gap-3 justify-between">
        <div
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${eq(slippageTolerance, 0.001) ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${eq(slippageTolerance, 0.003) ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${eq(slippageTolerance, 0.005) ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${!(eq(slippageTolerance, 0.001) || eq(slippageTolerance, 0.003) || eq(slippageTolerance, 0.005))
      ...
      <Row>
        ...
        {slippageToleranceState === 'too small' && (
          <div className={`flex-1 w-0 mt-2 mobile:mt-6 text-[#e3dc8b] text-xs mobile:text-sm`}>
