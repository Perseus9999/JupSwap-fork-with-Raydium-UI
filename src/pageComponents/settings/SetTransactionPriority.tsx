  ...
  return (
    <>
      ...
      <Grid className="gap-3 justify-between grid-cols-3 mobile:grid-cols-2">
        <Row
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority === 'auto' || transactionPriority == null ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
        ...
        <Row
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority === 0 ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <Row
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${Object.is(transactionPriority, 0.00005) ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <Row
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${Object.is(transactionPriority, 0.005) ? 'ring-1 ring-inset ring-[#39D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <div
          className={`py-1 px-3 bg-[#04133d] rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority != 'auto' &&
              !(
