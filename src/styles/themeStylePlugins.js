  ...
  const cyberpunkLightBorders = {
    '.cyberpunk-border': {
      ...
      '&::after': {
        ...
        background: 'linear-gradient(246deg, #f04a44 7.97%, #2b6aff 49.17%, #39d0d8 92.1%) border-box',
  ...
  addUtilities(
    {
      ...
      '.cyberpunk-bg-light-acceleraytor': {
        ...
        '&::before': {
          ...
          pointerEvents: 'none',
          background:
            'linear-gradient(221.5deg, #f04a44 16.15%, rgba(218, 46, 239, 0) 84.46%), radial-gradient(53.22% 53.22% at 93.67% 75.22%, rgba(218, 46, 239, 0.5) 0%, rgba(57, 208, 216, 0.5) 55.21%, rgba(84, 44, 238, 0.5) 100%), radial-gradient(63.44% 63.44% at 42.78% 105%, #39D0D8 0%, #542CEE 100%)',
...
exports.glassStyle = plugin(({ addUtilities }) => {
  ...
  addUtilities({
    '.home-rainbow-button-bg': {
      borderRadius: '12px',
      background: 'linear-gradient(245.22deg, #f04a44 35%, #2b6aff 65.17%, #39d0d8 92.1%)',
